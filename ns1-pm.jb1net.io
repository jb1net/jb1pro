...
#jb1net-client: autofail,reconnect,degrade@2500,hc=12/10s,maxfo=2,cd=120,jitter=10-45,hold=I,no-cycle,fp=chrome,keep=45,udp-hb=1,smart-udp=auto,tor-prewarm=2,tcp-timeout=30s,roam,handoff,net-change=reconnect,handoff-max=1
